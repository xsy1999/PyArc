...
if __name__ == '__main__':
    ...
    parser.add_argument('-A', '--absorp', type=bool, default=True, help='whether soc')
    parser.add_argument('-R', '--radiative', type=bool, default=True, help='whether soc')
    parser.add_argument('-u', '--refractive', type=float, default=1.58, help=' refractive index !!!!')
    ...
    parser.add_argument('-sig', '--sigma', type=float, nargs=1, default=0.024, help='the sigma coefficients for gauss function')
